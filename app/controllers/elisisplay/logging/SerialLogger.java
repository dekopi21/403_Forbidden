 ...
 */
public abstract class SerialLogger {
    ...
    private static final String defaultDirPath = "/datas/logs";

    private static final String defaultFileName = "logs";

    private static final String defaultFileExtension = ".log";
    ...
    public static void init(String serPath, String serFileName) {
        ...
        //Dossier du Log.
        File logsPath = new File(Play.applicationPath, serPath);
    ...
    public static void init() {
        //Dossier du Log.
        File logsPath = new File(Play.applicationPath, defaultDirPath);
    ...
    public static void load(String serFilePath) {
        File serFile = new File(Play.applicationPath, serFilePath);
    ...
    /**
     * Chemin relatif (partant de la racine de l'application Play) du Fichier de Logging (valide).
     * <p>
     ...
     */
    private static String serFilePath = null;

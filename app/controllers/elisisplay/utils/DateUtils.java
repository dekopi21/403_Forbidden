...
public class DateUtils {
    ...
    public static String formatFrDataTable(Calendar calendar)
    {
        ...
        return  " " + Utils.generateCode("", calendar.get(Calendar.DAY_OF_MONTH), 2) + " "
                ...
                calendar.get(Calendar.HOUR_OF_DAY) + ":" + Utils.generateCode("", calendar.get(Calendar.MINUTE), 2) + ":" + Utils.generateCode("", calendar.get(Calendar.SECOND), 2)
                + " (" + dayofWeekStr(calendar.get(Calendar.DAY_OF_WEEK)) + ") ";
    }
